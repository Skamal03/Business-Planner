            ...
            with open(self.filename, mode='r', newline='') as file:
                ...
                for row in reader:
                    if row:
                        ...
                        personal_info={"employee_id": employee_id, "fullname": fullname,"fathername": fathername,
    ...
    def display_employees(self):
        ...
        while current:
            employee_data=[current.personal_info.get("employee_id"), current.personal_info.get("fullname"),
                             current.job_details.get("department"),current.job_details.get("salary"),current.job_details.get("hours_per_week")]
